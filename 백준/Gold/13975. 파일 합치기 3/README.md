...
1715번 카드 정렬하기 문제와 똑같았다. </br>
우선순위 큐 문제는 유형이 비슷해서 이 두 문제만 파악하면 될 듯 하다. </br></br>
python3로 제출했다.</br>
아 그런데 이렇게 테스트케이스 여러개 있는 문제에서 계속 결과들 배열에 넣어놨다가 따로 출력 안하고 한번에 배열 print해서 첫트에 틀리는 실수한다;; 정신차리자..</br>

---

### 성능 요약

메모리: 193900 KB, 시간: 5708 ms
