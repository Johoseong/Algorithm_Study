...
### &#10071;풀이과정과 주의점
    ...
    직속상사에 대한 정보는 트리에 담고 DFS를 썼다.
    처음에, 한 직속상사에 대해 여러명의 직속부하가 있다는 생각을 간과해서 해맸다. 이 경우를 처리하려면 꼭 트리구조를 써야할 것 같다.
    그리고 한 직속부하가 여러번 칭찬 받을 수 있는 것도 까먹지 말기 !
